...
export const PatientCard = forwardRef(({ reservation, onDelete, onEdit, onComplete, isOverlay, style, ...props }, ref) => {
    return (
        <div
            ref={ref}
            style={{
                ...
                opacity: 1,
                border: isOverlay ? '2px solid var(--primary)' : '1px solid var(--border)',
...
const DraggablePatient = ({ reservation, onDelete, onEdit, onComplete }) => {
  const {
    attributes,
    listeners,
    setNodeRef,
